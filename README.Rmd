...
R packages are a good example, in that they require a very specific directory structure, yet have should have integrated, easily accessible documentation, such as vingettes. 
Quiltr can be used to integrate vignettes into a website. 
