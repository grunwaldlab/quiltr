...
It is designed complile embedded in computational science projects and making research notebooks.
...
Quiltr consolidates most types of files using in data science in any directory structure into a website.
...
The organization of the website and where HTML file content is displayed can be determined by the names of the files/directories or customized using configuration files scattered throughout the target directory.
